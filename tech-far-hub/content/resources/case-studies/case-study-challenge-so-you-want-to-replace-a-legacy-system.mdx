...
heading: Case Study Challenge - So, You Want to Replace a Legacy System…
...
<Summary>
This case study was a finalist selected as part of the [Digital Acquisition Professional Program Case Study Challenge](https://www.challenge.gov/?challenge=ditap-case-study). 
</Summary>
...
| VERY focused on CX, AI, and accessibility due to Executive Orders and risks |  |
...
| CX/AI | Accessibility |
| --- | --- |
| Find and read Executive Order 14058 | Accessibility/Section 508 is critical to any risk analyses for all new IT projects |
...
## Exercise 7: What is Accessibility? 

As it relates to technology, Accessibility is often tied to Section 508: https://www.section508.gov/

However, accessibility involves more in the technology realm than just ensuring that people who have visual or auditory impairments can utilize software or a website.
...
Answer the following questions: 
  ...
  - What broader concerns might this or other new technology address or exacerbate?
