...
- Emphasize the <a href="https://playbook.cio.gov/" target="_blank" class="usa-external_link">US Digital Service Playbook</a> in the solicitation so that vendors can see the process expectations prior to the demonstration.
