...
Example of items found on RFI's are:
...
The Government may engage Vendors that respond to this notice by seeking further information about capabilities or even an 8(a) direct award. All responses must be submitted through the Google docs form associated with this notice. Responses received via email will not be considered. Vendor submissions must be received no later than TIME on DATE.
