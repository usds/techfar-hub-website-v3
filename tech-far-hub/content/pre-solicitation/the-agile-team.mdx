...
- Some federal agencies, such as the [United States Digital Service](https://www.usds.gov/) and [18F](https://18f.gsa.gov/), have team members who can fill the contractor roles.
...
- Agile Team Governance

    This guide to [Governing Agile Teams](https://www.pmi.org/disciplined-agile/people/governing-agile-teams) offers unique perspective.

- Senior Executives & Agile

    This blog series from 18F discusses the role of [senior executives in supporting tech teams](https://18f.gsa.gov/2022/07/20/senior-executives-pt1/).

- Cross-Functional Teams

    Gain an appreciation for the [value of cross functional teams](https://18f.gsa.gov/2019/06/18/cross-functional-teams/) in agile development.

- Stakeholder Buy-In

    Every team needs an agile champion or two. Learn how to [gain stakeholder buy in for agile](https://18f.gsa.gov/2017/12/14/getting-stakeholder-buy-in-for-agile-development/) within your agency.
