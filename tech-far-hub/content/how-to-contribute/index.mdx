...
### Case Studies 
Case studies are a great way to contribute validated learning to the TechFAR Hub. They do not have to be long; in fact, we encourage brevity and [have created a short template](/assets/files/tfh-case-study-template.xlsx) to guide your contribution. The template focuses on the problem you solved, the challenges that you faced in solving it, and how your solution was applied and justified by policy, law or regulation. 
