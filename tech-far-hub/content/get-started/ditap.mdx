...
The following is the **2023** OFPP memo about transitioning the legacy FAC-C to the FAC-C (Professional). The DITAP memo's above, and the overall DITAP content is not affected by this change. The only change is the certification name changing from FAC-C Digital Services **Specialization** to FAC-C Digital Services **Credential**.
