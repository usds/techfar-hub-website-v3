...
This training and development program teaches federal government acquisition professionals to design innovative and flexible procurements for IT/Digital Services, and how to become change ambassadors. Once completed all students earn 60 to 80 Continuous Learning hours (CLs), and a Federal Acquisition Certification in Contracting (FAC-C) specialization in Digital Services (FAC-C-DS), soon to be called a Digital Services Credential.
...
Provides information on the creation of DITAP and further details about the DITAP program. The FAC-C-DS will soon be called the Digital Services Credential and will be available to contracting professionals, CORs, and PMs.
...
Introduces the new single-level [FAC-C (Professional)](https://www.fai.gov/certification/fac-c/new-fac-c-professional) that will eventually replace the FAC-C certification. All changes affecting the DITAP program are noted in the **Who can enroll** section below.
...
**1. A new single-level FAC-C (Professional) credential**
   ...
   - 60 - 80 CL's and a FAC-C in Digital Services (FAC-C-DS), soon to be called a Digital Services Credential, will be issued after successfully graduating the DITAP program.
...
**2. A current FAC-C Level II or III certification**
   ...
   - Applicants must have at least **two years** of federal government contracting experience to enroll in the DITAP program.
   - 60 - 80 CL's and a FAC-C in Digital Services (FAC-C-DS), soon to be called a Digital Services Credntial, will be issued after successfully graduating the DITAP program.
...
Agencies can negotiate with Authorized and Contingent providers, and can send students to open-enrollment cohorts offered by the providers. Level II/III FAC-C students who graduate from either type of provider receive a FAC-C-DS (soon to be called a Digital Services Credential).
