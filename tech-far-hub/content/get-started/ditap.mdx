...
This training and development program teaches federal government acquisition professionals to design innovative and flexible procurements for IT/Digital Services, and how to become change ambassadors. Once completed all students earn 60 to 80 Continuous Learning Points (CLPs), and Federal Acquisition Certification in Contracting (FAC-C) holders earn a Federal Acquisition Institute (FAI) FAC-C Credential in Digital Services (FAC-C-DS) certificate.
...
The following is the **2023** OFPP memo about transitioning the legacy FAC-C to the FAC-C (Professional). The DITAP memo's above, and the overall DITAP content are not affected by this change. The only change is the certification name changing from FAC-C Digital Services **Specialization** to FAC-C Digital Services **Credential**.

[Download memo](/assets/files/FAC_C_Mod_Memo_2023.pdf)

## Who can enroll in the DITAP program?

### February 2023 Update - USDS is currently working with our partners regarding the FAC-C modernization memo issued by OFPP on January 19, 2023 which introduced the new single-level FAC-C (Professional) credential that will eventually replace the FAC-C certification. The guidance will be sent to the DITAP providers and posted to the DITAP page February 3, 2023.

Per the 2018 memo, **Level II/III FAC-C** acquisition professionals assigned to acquisitions consisting primarily of digital services over FAR 13.500(c) thresholds are **required** to enroll in DITAP.
...
- Currently, FAC-COR/PM holders earn the CLPs and receive a “certificate of completion” but not a FAC-C-DS certificate. We are currently considering options regarding earning a FAC-C-DS certificate for non-FAC-C holders.
