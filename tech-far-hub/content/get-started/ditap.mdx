...
This training and development program teaches federal government acquisition professionals to design innovative and flexible procurements for IT/Digital Services, and how to become change ambassadors. Once completed all students earn 60 to 80 Continuous Learning Requirements (CLs), and Federal Acquisition Certification in Contracting (FAC-C) holders earn a Federal Acquisition Institute (FAI) FAC-C Credential in Digital Services (FAC-C-DS) certificate (Coming later in 2023--the DITAP certificate will become a credential).
...
### The remainder of February 2023

**FAC-C** 

Per the 2018 memo, FAC-C Level II/III acquisition professionals assigned to acquisitions consisting primarily of digital services over FAR 13.500(c) thresholds are **required** to enroll in DITAP.

**Federal Acquisition Certification for Contracting Officer’s Representatives (FAC-COR) and Federal Acquisition Certification for Program and Project Managers (FAC-P/PM)** 

Per the 2022 memo, FAC-COR and FAC-P/PM Level II/III acquisition professionals assigned to acquisitions consisting primarily of digital services over FAR 13.500(c) thresholds should be **encouraged** to attend DITAP training to create a cohesive team that fully understands how to buy digital services.
...
- Currently, FAC-COR/PM holders earn the CLs and receive a “certificate of completion” but not a FAC-C-DS certificate. We are currently considering options regarding earning a FAC-C-DS certificate for non-FAC-C holders and guidance will be included in  the next update later this year.

### Beginning March 2023

On January 19, 2023, OFPP issued a memo that reflects a new model of lifelong learning that reimagines how the federal government develops acquisition professionals.

The FAC-C (Professional) credential requires a minimum of one year of federal government contracting experience before acquisition professionals can begin to register for any courses. The FAC-C (Professional) curriculum has been updated to a four-core course training that follows the acquisition life cycle and includes a proctored exam and new Continuous Learning Requirements.

There will be an overlap of the old FAC-C certifications to the FAC-C (Professional) credential. 

   - All current FAC-C holders, no matter what Level, will automatically be awarded the new FAC-C (Professional) credential and are not required to take the four-core course training. This change will occur by February 28, 2023.
   - There is an 8-month transition period where acquisition professionals can continue to earn their legacy FAC-C levels.
   - All new acquisition professionals entering the federal government have to begin completing the new FAC-C (Professional) training program after one year of service.
   - The FAC-COR or FAC-P/PM certification Levels and requirements are not affected at this time.

Beginning **March 1, 2023**, applicants must submit one of the following to enroll in the DITAP program:

**1. A current FAC-C Level II or III certification**
   ...
   - A FAC-C in Digital Services (FAC-C-DS) certificate will will be issued after successfully graduating the DITAP program.

**2. A current FAC-P/PM, FAC-COR Level II or III certification**
   - At this time, the FAC-C-P/PM and FAC-COR certificates and requirements are not affected by the FAC-C changes.
   - Applicants must have at least **two years** of federal government contracting experience to enroll in the DITAP program.
   - FAC-COR/PM holders earn the CLs and receive a “certificate of completion” but not a FAC-C-DS certificate. We are currently considering options regarding earning a FAC-C-DS certificate for non-FAC-C holders and guidance will be updated later in 2023.
   
**3. A new single-level FAC-C (Professional) credential**
   - Applicants must have at least **two years** of federal government contracting experience to enroll in the DITAP program.
   - A FAC-C in Digital Services (FAC-C-DS) certificate will will be issued after successfully graduating the DITAP program.
